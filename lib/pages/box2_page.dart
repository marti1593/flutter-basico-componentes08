...
class _Box2PageState extends State<Box2Page> {
  ...
  BorderRadius _borderRadius = BorderRadius.circular(8); //para redondear las esquinas 

  Offset _offset = Offset(1.5, 2.0); // para las sombras 
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          this._color = Color.fromRGBO(random.nextInt(256), random.nextInt(256),
              random.nextInt(256), random.nextDouble()); //diferentes tipos de colores acorde a las medidas

          this._offset = Offset(
            random.nextInt(15).toDouble(),
            random.nextInt(15).toDouble(),
          ); //desplasamiento de la sombra
